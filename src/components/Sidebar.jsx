...
function Sidebar({ setShow,showSent }) {
  ...
  return (
    <Stack gap={3} className='p-4'>
      ...
      <ListGroup.Item className="d-flex justify-content-between" ><span className="link" onClick={() => showSent(false)}>Inbox</span> 
         <Badge bg="dark">{totalUnread} unread</Badge>  
      </ListGroup.Item>
      <ListGroup.Item className="d-flex justify-content-between" ><span className="link" onClick={() => showSent(true)}>Sent </span> 
